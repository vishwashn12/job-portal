...
const Hero = () => {
  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
        <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-20 text-center mx-2 rounded-xl'>
          <h2 className='text-2xl md:text-3xl lg:text-4xl font-medium mb-5'>Over 10,000+ jobs to apply</h2> 
          ...
          <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
            ...
            <button onClick={onSearch} className='bg-blue-600 px-10 py-2 rounded text-white m-1 '>Search</button>
          </div> 
        </div>
